...
SAFE_GOLD_ERROR_MESSAGES: Final[dict[str, str]] = {
    ...
    "tickflow_rate_limited": "TickFlow rate limited (HTTP 429)",
    "tickflow_auth_failed": "TickFlow authentication failed",
    "tickflow_network_failed": "TickFlow network failed",
    "tickflow_contract_failed": "TickFlow response contract failed",
    "tickflow_circuit_open": "Gold TickFlow circuit open after repeated 429",
