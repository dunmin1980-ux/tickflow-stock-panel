...
export function IndustryAnalysis() {
  ...
  return (
    <>
      ...
      <div className="min-h-full min-w-0 bg-[radial-gradient(circle_at_12%_0%,rgba(245,158,11,0.12),transparent_28%),radial-gradient(circle_at_85%_8%,rgba(244,63,94,0.08),transparent_28%)] px-3 py-4 sm:px-5 lg:px-6 lg:py-5">
